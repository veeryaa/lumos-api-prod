...
function createController(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const [result, status] = yield MembershipService_1.createMembership(req.body);
        if (status !== 'Error') {
            res.status(201).json({
                status: 201,
...
function findByIdController(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const [result, status] = yield MembershipService_1.findMembershipById(req.params.id);
        if (status !== 'Error') {
            res.status(200).json({
                status: 200,
...
function readAllController(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const [result, status] = yield MembershipService_1.readAllMembership();
        if (status !== 'Error') {
            res.status(200).json({
                status: 200,
...
function updateController(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const [result, status] = yield MembershipService_1.updateMembership(req.params.id, req.body);
        if (status !== 'Error') {
            res.status(200).json({
                status: 200,
